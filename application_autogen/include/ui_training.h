...
public:
    ...
    void setupUi(QDialog *training)
    {
        ...
        training->setStyleSheet(QString::fromUtf8("background-color: #5e69ee;"));
...
"}"));
    ...
    {
        training->setWindowTitle(QCoreApplication::translate("training", "\320\242\321\200\320\265\320\275\320\270\321\200\320\276\320\262\320\272\320\260 \321\201\320\273\320\276\320\262", nullptr));
